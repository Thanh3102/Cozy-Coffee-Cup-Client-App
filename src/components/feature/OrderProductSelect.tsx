...
const ProductList = ({ products, setSelected }: ProductListProps) => {
  ...
  return (
    <Fragment>
      <div className="flex flex-wrap -mx-3 overflow-y-scroll h-[70vh]">
          ...
          products.map((product) => (
            <div className="px-3 w-[25%]">
              <div
                ...
                } border-[2px] rounded-lg py-4 px-2 h-[180px]`}
                onClick={() => {
...
const OrderProductSelect = ({
  ...
  return (
    <Fragment>
      <div className="flex w-[80vw] h-[85vh]">
        ...
        <div className="flex-[3] px-6 py-2">
          {selectedProduct ? (
            <div className="flex flex-col justify-between h-full">
              <div className="h-fit">
                ...
                {productOptions && productOptions.length !== 0 ? (
                  <Fragment>
                    <p className="font-medium text-[18px]">Tùy chọn</p>
            ...
            <Fragment>
              ...
              <Button size="small" color="danger" onClick={close}>
                Đóng
              </Button>
            </Fragment>
          )}

  ...
  const fetchChartData = async () => {
    try {
      const { data } = await axiosClient.get<void, { data: Data }>(
        "/api/statistic/getOrderPaymentTypeChartData"
      );
      setData(data);
    } catch (error: any) {
  ...
  return (
    <Fragment>
      <div className="flex flex-col h-full">
        <h4 className="font-bold text-xl mb-4">Hình thức thanh toán</h4>
...
export default OrderPaymentTypeChart;
